    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <textarea value={input} onChange={(e) => setInput(e.target.value)} rows={14} className="tool-textarea" placeholder={mode === 'encode' ? 'hello world & more' : 'hello%20world%20%26%20more'} />
        </div>
        <div>
